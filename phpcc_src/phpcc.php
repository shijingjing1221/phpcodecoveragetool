...
define("PHPCOVERAGE_REPORT_DIR", realpath("../phpcc_report"));
define("PHPCOVERAGE_APPBASE_PATH", realpath("../../"));
define("XML_HOME", realpath("../phpcc_xml"));

require_once  PHPCOVERAGE_HOME."/remote/RemoteCoverageRecorder.php";
require_once  PHPCOVERAGE_HOME."/reporter/HtmlCoverageReporter.php";
echo PHPCOVERAGE_HOME."</br>";
...
$cov->generateReport($all_xml_files, true);
